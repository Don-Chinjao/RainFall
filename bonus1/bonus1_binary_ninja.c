...
{
    /* tailcall */
    return sub_8048310(0x10);
}

int32_t execl(char const* path, char const* arg, ...)
{
    /* tailcall */
    return execl();
}
